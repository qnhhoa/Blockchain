...
<html lang="en">
  <head>
    ...
    <title>Cập nhật trang trại</title>
        ...
        <div class="mycardstyle">
            <div class="greyarea">
                ...
                <form id="form2" autocomplete="off">
                    <div class="formitem">
                        <label type="text" class="formlabel"> Mã sản phẩm nhập kho </label>
                    ...
                    <div class="formitem">
                        <label type="text" class="formlabel"> Loại giống </label>
                        <input type="text" class="forminput" id="type" required>
                        <label type="text" class="formlabel"> Nguồn giống </label>
...
contractAddress = '0xe0e23520e002abd72B4214E9f94758ce8be1a120';
    ...
    $('#form2').on('submit', function(event) {
        ...
        var today = new Date();
        var thisdate = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();
        var info = "<br><br><b>Ngay cap nhat: "+thisdate+"</b><br>Loai giong: "+type +"</b><br>Nguon giong: "+source+"</b><br>Ngay thu hoach: "+date;
        web3.eth.getAccounts().then(async function(accounts) {
          var receipt = await contract.methods.update(prodid, info).send({ from: accounts[0], gas: 1000000 })
          .then(receipt => {
