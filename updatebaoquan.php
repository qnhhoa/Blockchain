        ...
        <div class="mycardstyle">
            <div class="greyarea">
                ...
                <form id="form2" autocomplete="off">
                    ...
                    <div class="formitem">
                        <label type="text" class="formlabel"> Cách bảo quản </label>
                        <input type="text" class="forminput" id="baoquan" required>
                    </div>
...
contractAddress = '0xe0e23520e002abd72B4214E9f94758ce8be1a120';
    ...
    $('#form2').on('submit', function(event) {
        ...
        var today = new Date();
        var thisdate = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();
        var info = "<br><br><b>Ngay cap nhat: "+thisdate+"</b><br>Bao quan: "+baoquan;
        web3.eth.getAccounts().then(async function(accounts) {
